...
export const LOG_IN_ICON_NAME = "ios-log-in"                  //Ionicons 
export const CHAT_ICON_NAME = "ios-chatbubbles-outline"                  //Ionicons 
export const UNDER_CONSTRUCTION_ICON_NAME = "ios-construct-outline"      //Ionicons
export const GOOGLE_LOGO_ICON_NAME = "logo-google"      //Ionicons
export const FACEBOOK_LOGO_ICON_NAME = "logo-facebook"      //Ionicons
